...
#
#     id = Column(UUID(as_uuid=True), primary_key=True, server_default=text("uuid_generate_v4()"))
#     contact_id = Column(ForeignKey('contact.id', ondelete='CASCADE', onupdate='CASCADE'), nullable=False, index=True)
#     address = Column(Text())
#
#     created = Column(DateTime, nullable=False, server_default=text("now()"))
#
#     contact = relationship('Contact')
#     search_vector = Column(TSVectorType('address'))
#
#
# class Email(Base):
#     __tablename__ = 'email'
...
#     id = Column(UUID(as_uuid=True), primary_key=True, server_default=text("uuid_generate_v4()"))
#     contact_id = Column(ForeignKey('contact.id', ondelete='CASCADE', onupdate='CASCADE'), nullable=False, index=True)
#     email_address = Column(String(500))
#
#     created = Column(DateTime, nullable=False, server_default=text("now()"))
#
#     contact = relationship('Contact')
#     search_vector = Column(TSVectorType('email_address'))
#
#
...
#
#     contact = relationship('Contact')
#     search_vector = Column(TSVectorType('number'))
